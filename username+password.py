...
class GetUsers(Users): 
    ...
    def getUser(self):
        username_input = entry_name.get()
        username_input = username_var
        email_id_input = entry_email.get()
        email_id_input = email_var
        
        label["text"] = (str(username_var) + str(email_var))
